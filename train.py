...
from util.misc import NativeScalerWithGradNormCount as NativeScaler #mae
...
def get_args_parser():
    ...
    # parser.add_argument('--resume', default='output_dir_pretrained/checkpoint-84.pth',
...
def main(args,mode,test_image_path=''):
    ...
    if mode == 'train':
        ...
        model = timm.create_model('resnet34', pretrained=True, num_classes=49, drop_rate=0.1, drop_path_rate=0.1)
...
if __name__ == '__main__':
    ...
    if mode == 'train':
        ...
        images = glob.glob('./AllData/test/菠萝/*.jpg')#测试集路径
        for image in images:
            print('\n')
